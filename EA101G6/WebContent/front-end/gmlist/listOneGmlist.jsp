			...
			<div class="row">
				<div class="col-12">
					...
					<div class="float-right">
						...
						<a href="update_gmlist_input.jsp" class="text-white"><span
							class="mr-2 text-white icon-instagram"></span> <span
							class="d-none d-md-inline-block">${account.getgmlistname()}</span></a>
						</c:if>
				...
				<div class="col-12">
					<nav class="site-navigation text-right ml-auto " role="navigation">
						...
						<ul
							...
							<li><a href="listAllgmlist.jsp" class="nav-link">店家列表</a></li>
